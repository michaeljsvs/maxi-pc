...
namespace TP_Maxi_PC.Repositorios
{
    ...
    public class PCRepositorio
    {
        ...
        {
            string sql = "SELECT P.idPC, A.nombre as marca, O.nombre as modelo, T.descripcion AS TipoPC, P.descripcion FROM PCs P JOIN Marcas A ON P.idMarca = A.idMarca JOIN Modelos O ON P.idModelo = O.idModelo JOIN TiposPCS T ON T.idTipoPC = P.idTipoPC";
