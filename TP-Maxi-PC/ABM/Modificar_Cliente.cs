                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                clientesRepositorio.modificarCliente(idCliente, txtNombre.Text, txtApe.Text, char.Parse(cmbSexo.SelectedValue.ToString()), dateTimePicker1.Value, txtCalle.Text, txtNroCalle.Text, Int32.Parse(cmbBarrio.SelectedValue.ToString()), Int32.Parse(cmbTipoDoc.SelectedValue.ToString()), System.Convert.ToInt32(txtDoc.Text));
